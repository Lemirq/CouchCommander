        ...
        <div className="main-grid">
          ...
          <Card className="panel">
            <CardHeader>
              ...
              <CardDescription>
                Manage the WebSocket server and frontend for device connections
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="server-controls">
                <Button
                  className={
                    serverStatus?.running ? "btn-success" : "btn-primary"
                  }
              ...
              {!serverStatus?.running && (
                <div className="text-xs text-muted-foreground mt-2 p-2 bg-muted/50 rounded">
                  ℹ️ Starting the server will automatically launch both the
                  WebSocket server and the mobile web app
                </div>
              )}
                ...
                <div className="server-info">
                  ...
                  <div className="info-row">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        copyToClipboard(serverStatus.local_ip || "")
                      }
                    >
          ...
          <Card className="panel">
            <CardHeader>
              ...
              <CardDescription>
                Connect your phone to control your computer
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="nextjs-status">
                ...
                {serverStatus?.running && (
                  <p className="text-xs text-muted-foreground mt-1">
                    ℹ️ Web app server starts automatically with WebSocket server
                  </p>
                )}
              </div>
                  ...
                  <div className="info-section">
                    ...
                    <div className="space-y-2">
                      <div className="info-row">
                        ...
                        <code className="value small text-xs bg-muted px-2 py-1 rounded">
                  ...
                  <div className="network-requirements">
                    ...
                    <ul className="space-y-1 text-sm text-muted-foreground">
                      ...
                      <li className="flex items-center gap-2">
                        ...
                        <Badge
                          variant={nextJsRunning ? "default" : "destructive"}
                          className="text-xs"
                        >
